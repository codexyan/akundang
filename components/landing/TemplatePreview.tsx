  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '0 40px 80px -16px rgba(0,0,0,0.25), 0 16px 40px -8px rgba(0,0,0,0.15), inset 0 1px 0 rgba(255,255,255,0.08)',
      }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-12 lg:gap-20 items-center mb-20 sm:mb-24">
          ...
          >
            <div className="relative">
              ...
              <div className="w-[220px] sm:w-[260px]">
                <PhoneMockup>
                  <div className="absolute inset-0" style={{ backgroundColor: FEATURED.primary }}>
                    {FEATURED.coverPhoto && (
                      <Image src={FEATURED.coverPhoto} alt={FEATURED.name} fill className="object-cover" sizes="260px" style={{ opacity: 0.6 }} />
                    )}
              ...
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-[80%] h-3 rounded-[50%] blur-md" style={{ background: 'radial-gradient(ellipse, rgba(0,0,0,0.1) 0%, transparent 70%)' }} />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-7 justify-center lg:justify-start">
              {[FEATURED.primary, FEATURED.accent, '#8fa99a', FEATURED.background].map((c) => (
                    ...
                    <div className="w-[110px] sm:w-[130px] opacity-50 mx-auto mb-3">
                      <PhoneMockup>
                        <div className="absolute inset-0" style={{ backgroundColor: tpl.bg }}>
                          <Image src={tpl.photo} alt={`${tpl.label} — coming soon`} fill className="object-cover" sizes="130px" style={{ opacity: 0.15 }} />
